...
var RawSqlResultsToEntityTransformer = /** @class */ (function () {
    ...
    RawSqlResultsToEntityTransformer.prototype.group = function (rawResults, alias) {
        ...
        if (alias.metadata.tableType === "view") {
            keys.push.apply(keys, __spreadArray([], __read(alias.metadata.columns.map(function (column) { return DriverUtils.buildAlias(_this.driver, alias.name, column.databaseName); }))));
        }
        else {
            keys.push.apply(keys, __spreadArray([], __read(alias.metadata.primaryColumns.map(function (column) { return DriverUtils.buildAlias(_this.driver, alias.name, column.databaseName); }))));
        }
